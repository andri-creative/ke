...
<template>
  <div class="fixed inset-0 flex flex-col bg-[#ECECEC] font-inter text-[#492828] overflow-hidden">
    <!-- Top Header -->
    ...
    <div class="flex flex-1 overflow-hidden pt-14 relative">
      ...
      <main class="flex-1 flex flex-col min-w-0 pb-4 overflow-hidden">
        <div class="flex-1 flex flex-col mx-2 lg:mx-4 rounded-3xl! shadow-lg! overflow-hidden bg-white border border-gray-100">
